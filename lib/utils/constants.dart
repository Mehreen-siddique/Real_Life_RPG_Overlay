...
class AppColors {
  ...
  static const Color darkBackground = Color(0xFF0B0B12); // Deep black
  static const Color darkSurface = Color(0xFF151521); // Dark surface
  static const Color darkCard = Color(0xFF1E1E2E); // Dark card surface
  static const Color darkCardAlt = Color(0xFF24243A); // Slightly elevated surface
  ...
  static const Color textDarkMuted = Color(0xFF9AA0B4); // Muted for dark UI

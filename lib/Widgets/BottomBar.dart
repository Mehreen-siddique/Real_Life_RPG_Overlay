            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: Theme.of(context).brightness == Brightness.dark
                    ? [
                        const Color(0xFF2A2A3E).withOpacity(0.8), // Dark theme light background
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Icon(
                icon,
                color: isSelected ? Colors.white : (Theme.of(context).brightness == Brightness.dark ? Colors.white70 : AppColors.textGray),
                size: 26,
                shadows: Theme.of(context).brightness == Brightness.dark
                    ? [const Shadow(color: Color(0x66A855F7), blurRadius: 5)]
                    : null,
              ),
